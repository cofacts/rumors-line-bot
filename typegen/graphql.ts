...
export type ListArticlesInInitStateQuery = { ListArticles: { edges: Array<{ node: { id: string, text: string | null, articleType: ArticleTypeEnum, attachmentUrl: string | null }, highlight: { text: string | null, hyperlinks: Array<{ title: string | null, summary: string | null } | null> | null } | null }> } | null };
